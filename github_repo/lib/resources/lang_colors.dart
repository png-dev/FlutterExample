...
const Map<String, Map<String, String>> LANG_COLORS = {
  ...
  "IGOR Pro": {"color": null, "url": "https://github.com/trending?l=IGOR-Pro"},
  ...
  "Perl 6": {"color": "#0000fb", "url": "https://github.com/trending?l=Perl-6"},
...
class LangColors {
  Map<String, Map<String, String>> _colors =
    ...
    try {
      if (colors.containsKey(language) && colors[language]['color'] != null) {
        ...
        if (strColor.startsWith('#') && strColor.length == 7) {
          ...
          return Color.fromARGB(0xff, int.parse('0x$strR'),
              int.parse('0x$strG'), int.parse('0x$strB'));
        }
      }
    } catch (e) {
      print(e.toString());
